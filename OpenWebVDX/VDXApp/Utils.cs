...
namespace VDXApp.Utils
{
    public static class VDXApplicationSettings
    {
        ...
        private static string Enviornment { get { return ConfigurationManager.AppSettings["Enviornment"]; } }
    }
    ...
    class MemoryFile : HttpPostedFileBase
    {
        ...
        {
            using (var file = File.Open(path, FileMode.CreateNew, FileAccess.ReadWrite))
                stream.CopyTo(file);
        }
    }
}